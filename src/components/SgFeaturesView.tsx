                      ...
                      <div key={cat}>
                        ...
                        <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.06)' }}>
                          ...
                          <div className="flex items-center px-5 py-2.5" style={{ background: 'rgba(255,255,255,0.02)', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                            <div className="w-[38%]"><span className="text-[11px] text-white/70 font-extrabold uppercase tracking-wider">Feature</span></div>
                            <div className="w-[14%] text-center"><span className="text-[11px] text-white/70 font-extrabold uppercase tracking-wider">Service in SG 🇸🇬</span></div>
                            <div className="w-[14%] text-center"><span className="text-[11px] text-white/70 font-extrabold uppercase tracking-wider">Model in SG 🇸🇬</span></div>
                            <div className="w-[34%] pl-3"><span className="text-[11px] text-white/70 font-extrabold uppercase tracking-wider">Comments</span></div>
                          </div>
                          {rows.map((f, i) => (
                            <div key={f.feature}
